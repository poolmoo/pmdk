/*
 * libpmemobj/safe_types.h -- definitions of libpmemobj type-safe macros for safe object handles
 */
...
#define S_TOID_NULL(t) ((S_TOID(t))OID_NULL)
...
/* type number of safe root object */
 ...
 */
#define S_TOID_VALID(o) (S_TOID_TYPE_NUM_OF(o) == safe_pmemobj_type_num((o).oid))
